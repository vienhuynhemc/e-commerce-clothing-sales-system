...
public class ForgotPasswordAdminModel {
    ...
    public void sendMailForgotPasswordVerifyCode(String email, String verifyCode){
        ...
        String text = "<p style=\"padding: 0;font-size: 17px;color: #707070;font-family:sans-serif\">TVTSHOP ADMIN account</p><h1 style=\"padding: 0;font-size: 41px;color: #2672ec;font-family:sans-serif\">Verify your account</h1><p style=\"padding: 0;font-size: 14px;color: #2a2a2a;font-family:sans-serif\">To complete forgotten TVTSHOP ADMIN account password, we just need to make sure this email address is yours.</p><p style=\"padding: 0;font-size: 14px;color: #2a2a2a;font-family:sans-serif\">To verify your account, use this security code: <strong>"+verifyCode+"</strong>, which is valid for <strong>180</strong> seconds</p><p style=\"padding: 0;font-size: 14px;color: #2a2a2a;font-family:sans-serif\">If you did not request this code then you can safely ignore this email. Maybe someone else entered your email address by mistake.</p><p style=\"padding: 0;font-size: 14px;color: #2a2a2a;font-family:sans-serif\">Thank you,</p><p style=\"padding: 0;font-size: 14px;color: #2a2a2a;font-family:sans-serif\">TVTSHOP</p>";
