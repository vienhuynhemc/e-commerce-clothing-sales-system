...
public class LoadNVKDAO {
    ...
    public ArrayList<AccountEmployee> loadNVKAll(int page, String type, String search, String orderBy){
        Connection con = null;
        ...
        try {
            ...
            String sql = "WITH list as(SELECT ROW_NUMBER() Over(ORDER BY " + type +" " + orderBy +") as n" +
                    ...
                    "                    from account a , employee e WHERE a.IDUser = e.IDUser and a.type = 1 and" +
            ...
            String sql1 = "select *from account a , employee e WHERE a.IDUser = e.IDUser and e.level = 1  and (a.FullName LIKE ? or a.Email LIKE ? or a.Phone LIKE ? or a.UserName LIKE ? or day(a.RegisDate) = ? or MONTH(a.RegisDate) = ? OR YEAR(a.RegisDate) = ?" +
    ...
    public static void main(String[] args) throws SQLException {
        ...
        System.out.println(lao.loadNVKAll(1,"Iduser","","ASC"));
