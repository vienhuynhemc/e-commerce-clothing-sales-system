...
public class ChangeWishListDAO {

    public ChangeWishListDAO() {
    }
...
//        System.out.println(ma_size);
        ...
        try {
            ...
            String check = "SELECT * FROM yeu_thich WHERE ma_sp = ? and ma_kh = ? and ma_mau = ? and ma_size = ?";
            ...
            if (rs.next()){
                ...
                String soluong = "select so_luong from yeu_thich WHERE ma_sp = ? and ma_kh = ? and ma_mau = ? and ma_size = ?";
                ...
                exe = "UPDATE yeu_thich set so_luong = " +soluongsp +" WHERE ma_sp = ? and ma_kh = ? and ma_mau = ? and ma_size = ?";
            }else{
                exe = "UPDATE yeu_thich set so_luong = " +so_luong_sp_hien_tai +" WHERE ma_sp = ? and ma_kh = ? and ma_mau = ? and ma_size = ?";
            ...
            String sql = "SELECT gio.ma_sp, gio.ma_kh, gio.ma_mau, gio.ma_size, hinh.link_hinh_anh, sp.ten_sp, s.ten_size,m.ten_mau,gio.so_luong, gia.gia_sp*gio.so_luong,giakm.gia_km*gio.so_luong from yeu_thich gio, san_pham sp, thong_tin_chi_tiet_sp tt, hinh_anh_sp hinh, gia_sp gia, gia_sp_khuyen_mai giakm,\n" +
                    "size s, mau m\n" +
