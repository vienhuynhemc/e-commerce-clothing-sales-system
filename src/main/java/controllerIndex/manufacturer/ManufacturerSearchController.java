...
@WebServlet(name = "ManufacturerSearchController", urlPatterns = "/ManufacturerSearchController")
public class ManufacturerSearchController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //  Lấy số trang tối đa
        int maximunPage = (int) request.getAttribute("maximumPage");
