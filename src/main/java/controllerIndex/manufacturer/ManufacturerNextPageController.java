...
@WebServlet(name = "ManufacturerNextPageController", urlPatterns = "/ManufacturerNextPageController")
public class ManufacturerNextPageController extends HttpServlet {
