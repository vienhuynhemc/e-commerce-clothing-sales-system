...
import model.IndexLanguageModel;
...
@WebServlet(name = "IndexLanguageController", urlPatterns = "/IndexLanguageController")
public class IndexLanguageController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Map<String, String> map = IndexLanguageModel.getInstance().getList(lang);
