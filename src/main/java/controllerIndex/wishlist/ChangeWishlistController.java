...
import model.wishlist.ChangeWishlistModell;
...
@WebServlet(name = "ChangeWishlistController",urlPatterns = "/ChangeWishlistController")
public class ChangeWishlistController extends HttpServlet {
...
//        System.out.println(ma_size);
        ...
        ChangeWishlistModell addCartModel = new ChangeWishlistModell();
