...
import model.language.ShoppingGuideLanguageModel;
...
@WebServlet(name = "ShoppingGuideLanguageController", urlPatterns = "/ShoppingGuideLanguageController")
public class ShoppingGuideLanguageController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Map<String, String> map = ShoppingGuideLanguageModel.getInstance().getList(lang);

        //  Lưu lại trong session
        request.getSession().setAttribute("langList", map);

        //  send redirect tới trang tương ứng
        response.sendRedirect("home/shopping_guide.jsp");
