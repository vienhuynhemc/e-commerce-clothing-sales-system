...
import model.language.PaymentPolicyLanguageModel;
...
@WebServlet(name = "PaymentPolicyLanguageController", urlPatterns = "/PaymentPolicyLanguageController")
public class PaymentPolicyLanguageController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Map<String, String> map = PaymentPolicyLanguageModel.getInstance().getList(lang);

        //  Lưu lại trong session
        request.getSession().setAttribute("langList", map);

        //  send redirect tới trang tương ứng
        response.sendRedirect("home/payment_policy.jsp");
