...
@WebServlet(name = "ChooseSizeLanguageController", urlPatterns = "/ChooseSizeLanguageController")
public class ChooseSizeLanguageController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Map<String, String> map = ChooseSizeLanguageModel.getInstance().getList(lang);

        //  Lưu lại trong session
        request.getSession().setAttribute("langList", map);

        //  send redirect tới trang tương ứng
        response.sendRedirect("home/chooseSize.jsp");
