...
import model.language.CartLanguageModel;
import model.language.ChangInfoCustomerLanguageModel;
...
@WebServlet(name = "CartLanguageController",urlPatterns = "/CartLanguageController")
public class CartLanguageController extends HttpServlet {
...
//  Lấy ngôn ngữ nhận vào
        ...
        Map<String, String> map = CartLanguageModel.getInstance().getList(lang);
