...
import model.language.ChooseSizeLanguageModel;
import model.language.MembershipPolicyLanguageModel;
...
@WebServlet(name = "MembershipPolicyLanguageController", urlPatterns = "/MembershipPolicyLanguageController")
public class MembershipPolicyLanguageController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Map<String, String> map = MembershipPolicyLanguageModel.getInstance().getList(lang);

        //  Lưu lại trong session
        request.getSession().setAttribute("langList", map);

        //  send redirect tới trang tương ứng
        response.sendRedirect("home/membership_policy.jsp");
