...
@WebServlet(name = "ChangeInfoLanguageController",urlPatterns = "/ChangeInfoLanguageController")
public class ChangeInfoLanguageController extends HttpServlet {
...
//  Lấy ngôn ngữ nhận vào
        ...
        Map<String, String> map = ChangInfoCustomerLanguageModel.getInstance().getList(lang);
