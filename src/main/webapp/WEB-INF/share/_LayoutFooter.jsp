                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="aa-footer-widget">
                                    <div class="aa-footer-widget">
                                        ...
                                        <ul class="aa-footer-nav">
                                            <li><a href="chooseSize.jsp">Hướng dẫn chọn size</a></li>
                                            <li><a href="shopping_guide.jsp">Hướng dẫn mua hàng</a></li>
                                            <li><a href="membership_policy.jsp">Chính sách thành viên</a></li>
                                            <li><a href="payment_policy.jsp">Chính sách đổi trả</a></li>
                                            <li><a href="guarantee.jsp">Chính sách bảo hành</a></li>
                                            <li><a href="check_orders.jsp">Tra cứu đơn hàng</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
