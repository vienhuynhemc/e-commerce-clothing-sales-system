...
<div class="indexleft">
    ...
    <div class="indexleftselect">
        <div>
            ...
            <a href="../home/thongTinTaiKhoanNVK.jsp" class="indexleftselectitem  ">
                <div
                        <%if (request.getParameter("activeSelect") != null && request.getParameter("activeSelect").equals("thongTinTaiKhoanNVK")) {%>
                        class="active"
                        <%}%>
                >
