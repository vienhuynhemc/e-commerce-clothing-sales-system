                            ...
                            <div class="maindiv2" id="maindiv2">
                                ...
                                <div class="item">
                                    ...
                                    <div class="itemsubmit" onclick="showselect(this)">
                                        ...
                                        <i class="fa fa-circle"></i>
                                        <div>
                                            <button onclick="editkhachhang(this)"><i
                                    ...
                                    <div>
                                        <div class="div11">
                                            ...
                                            <div class="div12inputlv2">
                                                ...
                                                <select name="" id="">
                                                    ...
                                                    <option value="" selected>Juno - Thương hiệu thời trang cao cấp
                                                    </option>
                                                    <option value="">An Phước – Tỉ mỉ trong từng đường kim mũi chỉ
                                                    </option>
                                                    <option value="">Việt Tiến - Thương hiệu của sự khẳng định</option>
                                                    <option value="">NOVELTY - Vẻ đẹp của người Việt được tôn vinh
                                                    </option>
                                                    ...
                                                    <option value="">SEA Collection - Chuyên cung cấp các mặt hàng thời
                                                        trang
                                                        trẻ.
                                                    </option>
                                            ...
                                            <div class="gioitinh">
                                                ...
                                                <div>
                                                    ...
                                                    <button class="activebutton" onclick="nu2(this)"
                                                        id="gioitinhnu">Nữ</button>
                                                </div>
                                            </div>
                                            <div class="linediv12"></div>
                                                        ...
                                                        <div class="listMauItemleft">
                                                            ...
                                                            <div>
                                                                ...
                                                                <i class="fa fa-angle-left"
                                                                    onclick="movehinhleft2(this)"></i>
                                                                <i class="fa fa-angle-right"
                                                                    onclick="movehinhright2(this)"></i>
                                                                <input type="number" style="display: none;" value="0">
                                                            </div>
                                                        </div>
                                                        <div class="removecolor">
                                                            <button onclick="themhinh2(this)"><i
                                        ...
                                        <div class="div13">
                                            ...
                                            <button onclick="themsize2(this)"><i class="fa fa-plus"></i> Thêm
                                                size</button>
                                            <div class="sizedachon">
                                                ...
                                                <div class="listSize">
                                                    <div class="listSizeItem">
                                                        ...
                                                        <button onclick="removeSize2(this)"><i
                                                                class="fa fa-trash"></i></button>
                                                    </div>
                                                    <div class="listSizeItem">
                                                        <div>
                    ...
                    <div id="div1">
                        <div>
                            <div class="div11">
                                ...
                                <div class="div12inputlv2">
                                    ...
                                    <select name="" id="">
                                        ...
                                        <option value="">May 10 - Thương hiệu của bảy thập kỉ</option>
                                        <option value="">PT2000 - Thời trang dành cho giới trẻ</option>
                                        <option value="">SEA Collection - Chuyên cung cấp các mặt hàng thời trang trẻ.
                                        </option>
                                        <option value="">Ninomaxx - Thương hiệu thời trang hàng đầu</option>
                                        <option value="">Nem Fashion</option>
                                        <option value="">ELISE</option>
                            ...
                            <div class="div12">
                                ...
                                <div class="buttondiv12">
                                    <button class="buttonthemmau" onclick="themmau(this)"><i class="fa fa-plus"></i>
                                        Thêm
                                        màu
                                    </button>
                                    <button onclick="taomaumoi()">Tạo màu mới</button>
