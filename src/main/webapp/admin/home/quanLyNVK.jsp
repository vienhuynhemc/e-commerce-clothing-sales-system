        ...
        <div>
            ...
            <div class="indexleftselectitemlv2" onclick="indexleftselectitemlv2(this)">
                ...
                <ul>
                    ...
                    <li class="activelv2"><a href="quanLyNVK.html"><i class="fa fa-cube"></i>Nhân viên kho</a></li>
                    ...
                    <div class="item">
                        ...
                        <div>
                            ...
                            <div class="div13">
                                ...
                                <div class="div12input">
                                    <label for="">Giới thiệu</label>
                                    <input type="text" placeholder="Nhập số giới thiệu ở đây" value="Xinh đẹp như tên">
                                </div>
                                <div class="linediv12"></div>
                                <button><i class="fa fa-save"></i>Lưu</button>
                                <button onclick="trove()"><i class="fa fa-arrow-left"></i> Trở về quản
                    ...
                    <div class="item">
                        ...
                        <div>
                            ...
                            <div class="div13">
                                ...
                                <div class="div12input">
                                    <label for="">Giới thiệu</label>
                                    <input type="text" placeholder="Nhập số giới thiệu ở đây" value="Có làm mới có ăn">
                                </div>
                                <div class="linediv12"></div>
                                <button><i class="fa fa-save"></i>Lưu</button>
                                <button onclick="trove()"><i class="fa fa-arrow-left"></i> Trở về quản
