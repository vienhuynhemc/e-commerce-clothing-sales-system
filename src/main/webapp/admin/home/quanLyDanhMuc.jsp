        ...
        <div>
            ...
            <div class="indexleftselectitemlv2" onclick="indexleftselectitemlv2(this)">
                ...
                <ul>
                    ...
                    <li class="activelv2"><a href="quanLyDanhMuc.html"><i class="fa fa-sticky-note-o"></i>Danh
                        mục</a></li>
                </ul>
                    ...
                    <div class="item">
                        ...
                        <div>
                            ...
                            <div class="div12">
                                ...
                                <div class="div12input">
                                    <label for="">* Tên danh mục</label>
                                    <input type="text" placeholder="Nhập tên danh mục ở đây" value="Áo phong">
                                </div>
                                <div class="linediv12"></div>
                                <button><i class="fa fa-save"></i>Lưu</button>
                                <button onclick="trove()"><i class="fa fa-arrow-left"></i> Trở về quản lý</button>
                    ...
                    <div class="item">
                        ...
                        <div>
                            ...
                            <div class="div12">
                                ...
                                <div class="div12input">
                                    <label for="">* Tên danh mục</label>
                                    <input type="text" placeholder="Nhập tên danh mục ở đây" value="Áo sơ mi">
                                </div>
                                <div class="linediv12"></div>
                                <button><i class="fa fa-save"></i>Lưu</button>
                                <button onclick="trove()"><i class="fa fa-arrow-left"></i> Trở về quản lý</button>
                    ...
                    <div class="item">
                        ...
                        <div>
                            ...
                            <div class="div12">
                                ...
                                <div class="div12input">
                                    <label for="">* Tên danh mục</label>
                                    <input type="text" placeholder="Nhập tên danh mục ở đây" value="Áo khoác">
                                </div>
                                <div class="linediv12"></div>
                                <button><i class="fa fa-save"></i>Lưu</button>
                                <button onclick="trove()"><i class="fa fa-arrow-left"></i> Trở về quản lý</button>
                    ...
                    <div class="item">
                        ...
                        <div>
                            ...
                            <div class="div12">
                                ...
                                <div class="div12input">
                                    <label for="">* Tên danh mục</label>
                                    <input type="text" placeholder="Nhập tên danh mục ở đây" value="Quần jean">
                                </div>
                                <div class="linediv12"></div>
                                <button><i class="fa fa-save"></i>Lưu</button>
                                <button onclick="trove()"><i class="fa fa-arrow-left"></i> Trở về quản lý</button>
                    ...
                    <div class="item">
                        ...
                        <div>
                            ...
                            <div class="div12">
                                ...
                                <div class="div12input">
                                    <label for="">* Tên danh mục</label>
                                    <input type="text" placeholder="Nhập tên danh mục ở đây" value="Quần kaki">
                                </div>
                                <div class="linediv12"></div>
                                <button><i class="fa fa-save"></i>Lưu</button>
                                <button onclick="trove()"><i class="fa fa-arrow-left"></i> Trở về quản lý</button>
                    ...
                    <div class="item">
                        ...
                        <div>
                            ...
                            <div class="div12">
                                ...
                                <div class="div12input">
                                    <label for="">* Tên danh mục</label>
                                    <input type="text" placeholder="Nhập tên danh mục ở đây" value="Quần shorts">
                                </div>
                                <div class="linediv12"></div>
                                <button><i class="fa fa-save"></i>Lưu</button>
                                <button onclick="trove()"><i class="fa fa-arrow-left"></i> Trở về quản lý</button>
                    ...
                    <div class="item">
                        ...
                        <div>
                            ...
                            <div class="div12">
                                ...
                                <div class="div12input">
                                    <label for="">* Tên danh mục</label>
                                    <input type="text" placeholder="Nhập tên danh mục ở đây" value="Quần vải">
                                </div>
                                <div class="linediv12"></div>
                                <button><i class="fa fa-save"></i>Lưu</button>
                                <button onclick="trove()"><i class="fa fa-arrow-left"></i> Trở về quản lý</button>
                    ...
                    <div class="item">
                        ...
                        <div>
                            ...
                            <div class="div12">
                                ...
                                <div class="div12input">
                                    <label for="">* Tên danh mục</label>
                                    <input type="text" placeholder="Nhập tên danh mục ở đây" value="Đồ mặc nhà">
                                </div>
                                <div class="linediv12"></div>
                                <button><i class="fa fa-save"></i>Lưu</button>
                                <button onclick="trove()"><i class="fa fa-arrow-left"></i> Trở về quản lý</button>
                    ...
                    <div class="item">
                        ...
                        <div>
                            ...
                            <div class="div12">
                                ...
                                <div class="div12input">
                                    <label for="">* Tên danh mục</label>
                                    <input type="text" placeholder="Nhập tên danh mục ở đây" value="Áo mặc trong">
                                </div>
                                <div class="linediv12"></div>
                                <button><i class="fa fa-save"></i>Lưu</button>
                                <button onclick="trove()"><i class="fa fa-arrow-left"></i> Trở về quản lý</button>
                    ...
                    <div class="item">
                        ...
                        <div>
                            ...
                            <div class="div12">
                                ...
                                <div class="div12input">
                                    <label for="">* Tên danh mục</label>
                                    <input type="text" placeholder="Nhập tên danh mục ở đây" value="Quần tây">
                                </div>
                                <div class="linediv12"></div>
                                <button><i class="fa fa-save"></i>Lưu</button>
                                <button onclick="trove()"><i class="fa fa-arrow-left"></i> Trở về quản lý</button>
                    ...
                    <div class="item">
                        ...
                        <div>
                            ...
                            <div class="div12">
                                ...
                                <div class="div12input">
                                    <label for="">* Tên danh mục</label>
                                    <input type="text" placeholder="Nhập tên danh mục ở đây" value="Quần len">
                                </div>
                                <div class="linediv12"></div>
                                <button><i class="fa fa-save"></i>Lưu</button>
                                <button onclick="trove()"><i class="fa fa-arrow-left"></i> Trở về quản lý</button>
